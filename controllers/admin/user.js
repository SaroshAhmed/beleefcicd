...
const { getSignatureUrl } = require("../../utils/helperFunctions");
...
exports.getUser = async (req, res) => {
  try {
    ...
    user.signature = await getSignatureUrl(user.signature);
...
exports.updateUser = async (req, res) => {
  try {
    const { name, mobile, company, title, id, validLicence } = req.body;
